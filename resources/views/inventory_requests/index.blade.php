        ...
        @component('components.filters', ['title' => __('report.filters')])
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    {!! Form::select('source_location_id', $business_locations, null, [
                        'class' => 'form-control select2',
                        'style' => 'width:100%',
                        'id' => 'ir_source_location_id',
                        'placeholder' => __('lang_v1.all'),
                    ]) !!}
                </div>
            </div>
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    {!! Form::select('destination_location_id', $business_locations, null, [
                        'class' => 'form-control select2',
                        'style' => 'width:100%',
                        'id' => 'ir_destination_location_id',
                        'placeholder' => __('lang_v1.all'),
                    ]) !!}
                </div>
            </div>
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    {!! Form::select('requested_by', $users, null, [
                        'class' => 'form-control select2',
                        'style' => 'width:100%',
                        'id' => 'ir_requested_by',
                        'placeholder' => __('lang_v1.all'),
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    {!! Form::select('approved_by', $users, null, [
                        'class' => 'form-control select2',
                        'style' => 'width:100%',
                        'id' => 'ir_approved_by',
                        'placeholder' => __('lang_v1.all'),
            ...
            @slot('tool')
                <div class="box-tools">
                    <a class="btn btn-block btn-primary"
                        href="{{ action('App\Http\Controllers\InventoryRequestController@create') }}">
        ...
        $(document).ready(function() {
            if ($('#ir_date_filter').length == 1) {
                $('#ir_date_filter').daterangepicker(
                    dateRangeSettings,
                    function(start, end) {
                        $('#ir_date_filter').val(start.format(moment_date_format) + ' ~ ' + end.format(
                            moment_date_format));
                ...
                ajax: {
                    ...
                    data: function(d) {
                        if ($('#ir_date_filter').val()) {
                            var start = $('#ir_date_filter').data('daterangepicker').startDate.format(
                                'YYYY-MM-DD');
                            var end = $('#ir_date_filter').data('daterangepicker').endDate.format(
                                'YYYY-MM-DD');
                            d.start_date = start;
                            d.end_date = end;
                        }
            ...
            $('#ir_product_id, #ir_category_id, #ir_source_location_id, #ir_destination_location_id, #ir_requested_by, #ir_approved_by, #ir_status')
                .on('change', function() {
                    inventory_requests_table.ajax.reload();
                });
