            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <p class="help-block text-muted">Shown on the public digital menu page under the location name (e.g. welcome text or “Select a category to view menu”). Leave blank to use the default message.</p>
                        {!! Form::textarea('description', $location->description, [
                        'class' => 'form-control',
