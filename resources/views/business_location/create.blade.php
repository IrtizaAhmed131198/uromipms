<div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
        ...
        {!! Form::open(['url' => action([\App\Http\Controllers\BusinessLocationController::class, 'store']), 'method' =>
        'post', 'id' => 'business_location_add_form' ]) !!}
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        {!! Form::text('location_id', null, ['class' => 'form-control', 'placeholder' => __(
                        'lang_v1.location_id' ) ]); !!}
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        {!! Form::text('landmark', null, ['class' => 'form-control', 'placeholder' => __(
                        'business.landmark' ) ]); !!}
                    </div>
                </div>
                <div class="clearfix"></div>
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        {!! Form::text('zip_code', null, ['class' => 'form-control', 'placeholder' => __(
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        {!! Form::text('state', null, ['class' => 'form-control', 'placeholder' => __(
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        {!! Form::text('country', null, ['class' => 'form-control', 'placeholder' => __(
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        {!! Form::text('website', null, ['class' => 'form-control', 'placeholder' => __(
                        'lang_v1.website')]); !!}
                    </div>
                </div>
                <div class="clearfix"></div>
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        {!! Form::select('invoice_scheme_id', $invoice_schemes, null, ['class' => 'form-control',
                        'required',
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        {!! Form::select('sale_invoice_scheme_id', $invoice_schemes, null, ['class' => 'form-control',
                        'required',
                        'placeholder' => __('messages.please_select')]); !!}
                    </div>
                </div>
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        {!! Form::select('invoice_layout_id', $invoice_layouts, null, ['class' => 'form-control',
                        'required',
                        'placeholder' => __('messages.please_select')]); !!}
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        {!! Form::select('sale_invoice_layout_id', $invoice_layouts, null, ['class' => 'form-control',
                        'required',
                        'placeholder' => __('messages.please_select')]); !!}
                    </div>
                </div>
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                        {!! Form::label('description', 'Description / About this Location:') !!}
                        <p class="help-block text-muted">Shown on the public digital menu page under the location name. Leave blank to use the default message.</p>
                        {!! Form::textarea('description', null, [
                        'class' => 'form-control',
                        'placeholder' => 'e.g. Select a category to view menu',
                        'rows' => 5
                        ]) !!}
                    </div>
                </div>
