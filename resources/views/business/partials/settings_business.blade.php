<div class="pos-tab-content active">
    <div class="row">
        ...
        <div class="col-sm-4">
            <div class="form-group">
                {!! Form::label('login_background_image', __('business.login_background_image') . ':') !!}
                {!! Form::file('login_background_image', ['accept' => 'image/*']) !!}
                <p class="help-block"><i>@lang('business.login_background_image_help')</i></p>
                @if (!empty($login_background_image))
                    <div class="m-t-10">
                        <img src="{{ asset('uploads/login_backgrounds/' . $login_background_image) }}" alt="@lang('business.login_background_image')" class="img-responsive img-thumbnail" style="max-width: 260px;">
                        <div class="m-t-10">
                            <label>
                                {!! Form::checkbox('remove_login_background_image', 1, false, ['class' => 'input-icheck']) !!}
                                @lang('business.remove_login_background_image')
                            </label>
                        </div>
                    </div>
                @endif
