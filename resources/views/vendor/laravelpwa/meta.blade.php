   ...
   if ('serviceWorker' in navigator) {
    window.addEventListener('load', function() {
                ...
                registration.addEventListener('updatefound', function() {
                    ...
                    newWorker.addEventListener('statechange', function() {
                        if (newWorker.state === 'activated') {
                            ...
                            // Optional: Reload page to use new SW
        ...
        if (navigator.serviceWorker.controller) {
            console.log('✅ ServiceWorker is controlling this page');
        } else {
            console.log('⚠️ ServiceWorker is NOT controlling this page yet');
            console.log('💡 Refresh the page once after first install');
        }
    });
    }   

// Optional: Add a button to clear cache and reload
