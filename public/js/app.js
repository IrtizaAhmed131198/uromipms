$(document).ready(function() {
    ...
    business_locations = $('#business_location_table').DataTable({
        ...
        columns: [
            ...
            { data: 'landmark', name: 'business_locations.landmark' },
            { data: 'city', name: 'business_locations.city' },
            { data: 'zip_code', name: 'business_locations.zip_code' },
            { data: 'state', name: 'business_locations.state' },
            { data: 'country', name: 'business_locations.country' },
            ...
            { data: 'business_link', name: 'business_link', orderable: false, searchable: false },
    ...
    $(document).on('click', '.delete-sale-all', function(e) {
        e.preventDefault();

        swal({
            title: LANG.sure,
            text: LANG.confirm_delete_all,
            icon: 'warning',
            buttons: true,
            dangerMode: true,
        }).then((willDelete) => {
...
$(document).on('click', 'button.delete-location', function() {
    swal({
        title: LANG.sure,
        text: LANG.delete_business_location_confirmation,
        icon: 'warning',
        buttons: {
            cancel: {
                text: LANG.exit,
