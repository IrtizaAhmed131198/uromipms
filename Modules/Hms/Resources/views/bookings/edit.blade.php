...
@section('content')
    ...
    <div class="col-md-12 text-center" style="display:flex;gap:12px;justify-content:center;align-items:center;flex-wrap:wrap;">
        ...
        <a href="{{ route('hms.booking.receipt', ['id' => $transaction->id]) }}" data-id="{{ $transaction->id }}" class="tw-dw-btn tw-dw-btn-warning tw-text-white tw-dw-btn-lg js-generate-receipt">@lang('hms::lang.reciept_booking')</a>
    </div>
       {!! Form::close() !!}
           {{-- model  --}}
