...
@section('content')
    ...
    <section class="content">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-6">
                                <div class="form-group">
                                    <select name="discount_type_select" id="discount_type_select" class="form-control">
        ...
        <div class="col-md-12 text-center" style="display:flex;gap:12px;justify-content:center;flex-wrap:wrap;">
            ...
            <button type="submit" name="submit_action" value="check_in"
                class="tw-dw-btn tw-dw-btn-success tw-text-white tw-dw-btn-lg">Check In</button>
        </div>
        {!! Form::close() !!}
        {{-- model  --}}
