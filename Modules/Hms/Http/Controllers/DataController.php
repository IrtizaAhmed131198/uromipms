    ...
    public function user_permissions()
    {
        return [
            ...
            [
             ...
             [
                'value' => 'hms.reciept_booking',
                'label' => __('hms::lang.reciept_booking'),
                'default' => false,
            ],
            [
                'value' => 'hms.cancel_booking',
                'label' => __('hms::lang.cancel_booking'),
                'default' => false,
            ],
            [
                'value' => 'hms.extend_stay',
                'label' => __('hms::lang.extend_stay'),
                'default' => false,
            ],
            [
            ...
            [
                'value' => 'hms.room_status',
                'label' => __('hms::lang.room_status'),
                'default' => false,
            ],
            [
